...
class RobotBeginnerGuidePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const SingleChildScrollView(
      padding: EdgeInsets.fromLTRB(22, 22, 22, 110),
      child: Column(
        ...
        children: [
          ...
          GuideStepCard(
              step: '01',
              title: '连接机器人',
              description: '进入蓝牙页，扫描附近设备，选择 LinBot 或你的机器人蓝牙名称进行连接。'),
          GuideStepCard(
              step: '02',
              title: '切换表情',
              description: '在首页选择开心、委屈、生气、惊讶、困困、喜欢等表情，机器人脸部会立即变化。'),
          GuideStepCard(
              step: '03',
              title: '控制移动',
              description: '进入 Move 页面发送前进、后退、左转、右转、停止和到我旁边等指令。'),
          GuideStepCard(
              step: '04',
              title: '全屏展示',
              description: '点击首页机器人脸部卡片，可横屏全屏显示表情，再次点击或返回即可退出。'),
          SizedBox(height: 12),
          ActivityItem(
            emoji: '💡',
            title: '开发提示',
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  color: Color(0xB8FFFFFF), fontSize: 14, height: 1.5),
            ),
          ],
        ),
      ),

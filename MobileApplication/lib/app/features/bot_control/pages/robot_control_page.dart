        ...
        children: [
          ...
          Material(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  const Text('Robot Movement',
                      style: TextStyle(
                          color: AppColors.ink,
                          fontSize: 20,
                          fontWeight: FontWeight.w700)),
                  const SizedBox(height: 6),
                  Text('蓝牙状态：${statusText(connectState)}',
                  ...
                  ControlButton(
                      ...
                      orange: true,
                      onTap: () =>
                          onMoveCommand(CompanionMoveCommand.comeHere)),
                    ...
                    children: [
                      Expanded(
                          child: ControlButton(
                              text: '左转',
                              onTap: () =>
                                  onMoveCommand(CompanionMoveCommand.left))),
                      ...
                      Expanded(
                          child: ControlButton(
                              ...
                              danger: true,
                              onTap: () =>
                                  onMoveCommand(CompanionMoveCommand.stop))),
                      const SizedBox(width: 12),
                      Expanded(
                          child: ControlButton(
                              text: '右转',
                              onTap: () =>
                                  onMoveCommand(CompanionMoveCommand.right))),
                    ],
                  ),
                  const SizedBox(height: 12),
                  ControlButton(
                      text: '后退',
                      onTap: () =>
                          onMoveCommand(CompanionMoveCommand.backward)),
                ],
              ),
            ),
          ),
